...
import com.ds.liverecorder.databinding.ItemConcertPosterBinding
...
class ConcertPosterAdapter :
    ListAdapter<Concert, ConcertPosterAdapter.ConcertViewHolder>(DIFF_CALLBACK) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ConcertViewHolder {
        val binding = ItemConcertPosterBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    class ConcertViewHolder(private val binding: ItemConcertPosterBinding) : RecyclerView.ViewHolder(binding.root) {
